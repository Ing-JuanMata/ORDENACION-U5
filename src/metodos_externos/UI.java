...
public class UI extends javax.swing.JFrame {
    ...
    private void btnCrearActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnCrearActionPerformed
        ...
        switch (comboMetodos.getSelectedIndex()) {
            case 0:
                natural = new MezclaNatural(cantidad, minimo, maximo);
                break;
            case 1:
                directa = new MezclaDirecta(cantidad, minimo, maximo);
                break;
            case 2:
                int[] datosA = new int[(int) (cantidad)];
                int[] datosB = new int[(int) (cantidad)];
                for (int i = 0; i < datosA.length; i++) {
                    datosA[i] = (int) (Math.random() * (maximo - minimo) + minimo);
                    datosB[i] = (int) (Math.random() * (maximo - minimo) + minimo);
                }

                intercalacion = new Intercalacion(datosA, datosB);
                break;
        }
